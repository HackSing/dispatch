/** 内联 SVG 图标集:描边/填充随 currentColor,禁用 emoji 与字符图标(设计规范) */
...
export function ChevronUpDownIcon(): React.JSX.Element {
  return (
    <svg
      width="8"
      height="12"
      ...
      aria-hidden="true"
    >
      <path d="M1.5 4.5 4 2l2.5 2.5" />
      <path d="M1.5 7.5 4 10l2.5-2.5" />
    </svg>
  )
}
...
export function ChipIcon(): React.JSX.Element {
  return (
    <svg
      width="13"
      height="13"
...
export function FolderIcon(): React.JSX.Element {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M1.6 4.4a1.2 1.2 0 0 1 1.2-1.2h2.5l1.3 1.5h4.6a1.2 1.2 0 0 1 1.2 1.2v4.3a1.2 1.2 0 0 1-1.2 1.2H2.8a1.2 1.2 0 0 1-1.2-1.2z" />
    </svg>
  )
}
...
export function ChevronRightIcon(): React.JSX.Element {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M1.5 1.5 5.3 5.5 1.5 9.5" />
    </svg>
  )
}
...
export function CheckIcon(): React.JSX.Element {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M1.8 5.8 4.4 8.4l4.8-5.6" />
    </svg>
  )
}
